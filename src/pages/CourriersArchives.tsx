  ...
  const columns = useMemo<ColumnDef<CourierWithRelations>[]>(
    () => [
      ...
      },
      {
        ...
        meta: { exportLabel: "Date d'archivage" },
      },
      {
        accessorKey: "subject",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Courriers archivés</h1>
          <p className="text-muted-foreground">
            Consultation en lecture seule des courriers archivés.
          </p>
        </div>
      </div>
